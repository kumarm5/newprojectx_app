...
class TravelBooking(models.Model):
    myrequest = models.ForeignKey(MyRequest, on_delete=models.CASCADE, related_name='travel_my_request', null=True, blank=True)
    vendor = models.ForeignKey(CompanyVendor, on_delete=models.CASCADE, related_name='travel_check_vendor', null=True, blank=True)
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='travel_owner', blank=True, null=True)
